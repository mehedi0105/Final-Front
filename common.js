...
//  }
  ...
  window.onload = () => {
    ...
    if (!user_type) {
        ...
        <div class="container">
            ...
            <div class="col-12 col-md-4 mb-4">
              ...
              <form class="form-inline">
                <div class="input-group">
                  <input type="email" class="form-control" placeholder="Enter your email here" style="background-color: #909090;">
                  <div class="input-group-append">
                    <button type="submit" onclick="notifyLogin()" class="btn btn-primary">Subscribe</button>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="row mt-4">
            <div class="col-12 text-center">
              <p class="text-muted border-top pt-3">© 2024 workscout Company. All Rights Reserved.</p>
            </div>
          </div>
        </div>
      `;
      ...
      const div = document.createElement("div");
      div.innerHTML = `
        <div class="small-footer mt-3">
          <div class="text-center">
            © Theme by workscout.net. All Rights Reserved.
          </div>    
        </div>
      `;
      parent.appendChild(div);
